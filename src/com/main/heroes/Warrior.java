...
public class Warrior extends CharaterClass {
    public Warrior(int attackAmount, int healthPoints, int maxHealthPoints, int manaPoints, int maxManaPoints, int level, String name) {
